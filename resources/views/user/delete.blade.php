...
<!--HTML Content-->
<div class="container-fluid p-0" style= "margin-left: 80px; margin-right: 10px; margin-top:5px; padding-top: 20px;">
    <div class="card" style="position: relative; background-color: rgba(5, 15, 15, 0.5); color: #fff">
        ...
        <p class="card-text" style="font-family: 'Bell MT'; font-size: 30px"> "Are you sure you want to delete" --- {{ $user->first_name }} {{ $user->last_name }} ?</p>
            <!---->
            ...
            <div class="card-body">
                <div class="row h-100">
            <div class="mt-3">
                <a href="/users" class="btn btn-primary " style="font-family: 'Bell MT'; font-size: 21px">NO</a>
